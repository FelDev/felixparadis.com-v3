    ...
    <xsl:template match="/">
        <html>
            ...
            <body class="ph3 pb3 mid-gray">
                ...
                <a>
                    <a href="/sitemap.xml" class="link blue">Back to index</a>
                </a>
            </header>

            <xsl:apply-templates/>
            <footer class="mw8 center pv4 tc">
                This sitemap uses an open source <a href="https://github.com/pedroborges/xml-sitemap-stylesheet" title="Go to Github" class="link blue">XML Sitemap Stylesheet</a> created by <a href="https://pedroborg.es" title="Pedro Borges" class="link blue">pedroborg.es</a>
            </footer>
        </body>
    </html>
</xsl:template>
